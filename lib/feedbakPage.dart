          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
               showDialog(
      context: context,
      barrierDismissible: false, // عشان الطالب ما يقفلهوش بالغلط غير لما يدوس Done
      builder: (context) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15)), // شكل أشيك
        title: const Text('Detailed Performance Report', 
          style: TextStyle(fontWeight: FontWeight.bold, color: Colors.blue)),
        content: SizedBox(
          width: double.maxFinite, // بياخد عرض مناسب
          child: SingleChildScrollView( // أهم سطر عشان لو التقرير طويل
            child: Column(
              ...
              children: [
                ...
                Text(widget.feedback, style: const TextStyle(height: 1.4)), 
                const Divider(height: 30),
                const Text('Improvement Suggestions:', 
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Colors.orange)),
                const SizedBox(height: 8),
                // عرض الاقتراحات بشكل منسق
